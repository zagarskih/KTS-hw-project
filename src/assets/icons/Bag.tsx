...
const Bag: React.FC<LogoProps> = ({ className, stroke = '#151411' }) => {
  return (
    <svg
      className={className}
      width="30"
    ...
    >
      ...
      <path
        ...
        stroke-linejoin="round"
      />
      <path d="M19.3694 15H19.3806" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
      <path d="M10.6181 15H10.6294" stroke={stroke} stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
    </svg>
  );
};
